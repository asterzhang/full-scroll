  ...
  $.fn.fullscroll = function(options) {
    ...
    function mouseWheelHandler(e) {
      ...
      if (!isScrolling) {
        ...
        settings.animationDuration + settings.animationCD)
    ...
    if (settings.normalSelector) {
      $("body").on('mousewheel DOMMouseScroll', settings.normalSelector,
      function(e) {
        e.preventDefault();
        return false;
      })
